        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Average</Typography>
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Appraisal</Typography>
                  <Box
                    sx={{
                      height: 85,
                      width: 85,
                  ...
                  >
                    ...
                    <CircularProgress
                      ...
                      value={75}
                      size={85}
                      sx={{ transform: 'rotate(90deg) !important', color: '#1976d2', position: 'absolute' }}
                    />
                  </Box>
                </Box>
              </Box>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Upskill your career while setting the path of your learning with our meticulously crafted courses with industry recognised certifications!
            </Typography>
