            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    "Become the 1% in the pool by adding a glittering summer training and internship certificate verified by HR's of Top MnC's in your profile!"
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="subtitle1" sx={{ color: 'text.secondary', lineHeight: 1.3 }}>
                  Industry Recognised Certificates with all courses
                </Typography>
              </Box>
            </Box>
            <Box sx={{ lineHeight: 0 }}>
